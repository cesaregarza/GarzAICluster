...
| Current image | `registry.digitalocean.com/sendouq/agent-platform:sha-0e631187996d` |
...
spec:
  ...
  template:
    spec:
      ...
      containers:
        - name: schema-check
          image: registry.digitalocean.com/sendouq/agent-platform:sha-0e631187996d
          envFrom:
            - secretRef:
