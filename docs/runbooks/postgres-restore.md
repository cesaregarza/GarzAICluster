...
| Current image | `registry.digitalocean.com/sendouq/agent-platform:sha-512920559216` |
...
spec:
  ...
  template:
    spec:
      ...
      containers:
        - name: schema-check
          image: registry.digitalocean.com/sendouq/agent-platform:sha-512920559216
          envFrom:
            - secretRef:
