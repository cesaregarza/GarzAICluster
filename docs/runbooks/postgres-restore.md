...
| Current image | `registry.digitalocean.com/sendouq/agent-platform:sha-a5b1db23009c` |
...
spec:
  ...
  template:
    spec:
      ...
      containers:
        - name: schema-check
          image: registry.digitalocean.com/sendouq/agent-platform:sha-a5b1db23009c
          envFrom:
            - secretRef:
