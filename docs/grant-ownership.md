...
| `agent_workloads.opencode_orchestrate` | `limitations` | `workload_release` | `digest_moves_repin_remint` |
| `agent_workloads.opencode_orchestrate` | `model_bounds` | `workload_release` | `digest_moves_repin_remint` |
...
| `agent_workloads.opencode_propose` | `limitations` | `workload_release` | `digest_moves_repin_remint` |
| `agent_workloads.opencode_propose` | `model_bounds` | `workload_release` | `digest_moves_repin_remint` |
...
| `agent_workloads.opencode_task` | `model_bounds` | `workload_release` | `digest_moves_repin_remint` |
...
| `agent_workloads.readonly_query` | `model_bounds` | `workload_release` | `digest_moves_repin_remint` |
